...
import com.sunnsoft.goodsdetaildemo.IdeaViewPager;
...
public class IdeaScrollView extends ScrollView {
    ...
    private void scrollToPosition(int position) {
        getOnScrollChangedColorListener().onChanged(Math.abs(arrayDistance.get(position)) / Float.valueOf(point.x - headerHeight));
